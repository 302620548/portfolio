...
let playerTurnElement = document.querySelector('.playerTurnElement')
...
function handleClickSpeelveld(event){
    if (players[1].turn === false) 
    {
        ...
        if (vakje.innerHTML == "") {
            ...
            console.log(model);
            players[1].turn = true;
            playerTurnElement.innerHTML = players[1].name + "'s turn: ";
        }
    }
    else{
        let vakje=event.target;
        ...
        if (vakje.innerHTML == "") {
            ...
            playerTurnElement.innerHTML = players[0].name + "'s turn: ";
        }
    }
    wincon();
}
...
function resetGame() {
    ...
    playerTurnElement.innerHTML = "✌️ It takes two to Tic Tac Toe! ✌️";
